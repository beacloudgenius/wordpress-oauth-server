  ...
  function display_rows() {
    ...
    if(!empty($records)){foreach($records as $rec){
      ...
      foreach ( $columns as $column_name => $column_display_name ) {
        ...
        //Display the cell
        switch ( $column_name ) {
          case "name": echo '<td '.$attributes.'><strong><a href="'.$editlink.'" title="Edit">'.stripslashes($rec->name).'</a></strong><div class="row-actions"><span class="edit"><a class="thickbox" href="#TB_inline?width=600&height=550&inlineId=edit_client_'.$rec->client_id.'" title="Edit Client">Edit</a> | </span><span class="trash"><a class="submitdelete" title="Delete this Client permanently" onclick="wo_remove_client(\''.str_replace(" ","",$rec->client_id).'\');" href="#">Delete</a> | </span><span class="view"><a href="#TB_inline?width=300&height=100&inlineId=show_secret_'.$rec->client_id.'" class="thickbox" title="Viewing Secret for '.$rec->name.'">Show Secret</a></span></div> <div id="show_secret_'.$rec->client_id.'" style="display:none;"><h3 style="text-align:center;margin-top:40px;">'.$rec->client_secret.'</h3></div> <div id="edit_client_'.$rec->client_id.'" style="display:none;">'.edit_client_form($rec->client_id).'</div>'; break;
